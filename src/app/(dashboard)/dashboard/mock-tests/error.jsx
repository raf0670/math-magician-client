...
export default function MockTestsError({ error, reset }) {
  return (
    <div className="rounded-3xl border border-red-500/20 bg-red-500/10 px-6 py-8 text-left">
      <p className="text-xs font-bold uppercase tracking-[0.3em] text-red-400">Exam list unavailable</p>
      <h2 className="mt-2 text-lg font-semibold text-white">We could not load the mock tests right now.</h2>
