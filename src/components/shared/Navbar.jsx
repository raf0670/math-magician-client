...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full overflow-visible border-b border-[#DFB15B]/10 bg-[#0D0B14]/82 px-4 py-3 shadow-[0_16px_50px_rgba(0,0,0,0.26)] backdrop-blur-xl md:px-6">
            ...
            <div className="relative z-10 mx-auto flex max-w-7xl items-center justify-between gap-4">
                ...
                <div className="hidden items-center gap-3 md:flex">
                    {isLoggedIn ? (
                        ...
                        <>
                            <Link
                                href="/login"
                                className="inline-flex items-center gap-2 rounded-2xl border border-[#DFB15B]/28 bg-white/[0.025] px-5 py-2.5 text-sm font-semibold tracking-wide text-white transition-all duration-200 hover:border-[#DFB15B]/50 hover:bg-[#DFB15B]/8"
                            >
                ...
                <button
                    type="button"
                    onClick={toggleMenu}
                    className="z-50 flex h-11 w-11 items-center justify-center rounded-2xl border border-[#DFB15B]/18 bg-[#DFB15B]/10 text-[#DFB15B] shadow-[0_0_24px_rgba(223,177,91,0.08)] transition hover:border-[#DFB15B]/35 md:hidden"
            ...
            <AnimatePresence>
                {isOpen ? (
                    <motion.div
                        ...
                        className="fixed inset-0 z-40 flex flex-col overflow-hidden bg-[#0D0B14]/98 px-5 pt-24 text-white backdrop-blur-xl md:hidden"
                    >
                        ...
                        <div className="pointer-events-none absolute bottom-[-120px] left-[-80px] h-72 w-72 rounded-full bg-[#3156D4]/14 blur-3xl" />

                        <div className="relative z-10 flex flex-col gap-3 border-b border-white/7 pb-6">
