        ...
        <section className="min-w-0 max-w-full select-none">
            <div className="mb-4 flex min-w-0 flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div className="min-w-0">
                    ...
                    <h2 className="mt-2 break-words font-sans text-2xl font-semibold tracking-wide text-white [overflow-wrap:anywhere]">Your Practice Signal</h2>
                </div>
                        ...
                        <div className="relative z-10 flex h-full min-w-0 flex-col">
                            <div className="flex min-w-0 items-start justify-between gap-4">
                                <div className="min-w-0">
                                    ...
                                    <p className="mt-3 break-words font-sans text-4xl font-bold tracking-tight text-white [overflow-wrap:anywhere]">{item.value}</p>
                                </div>
