...
const NAV_ACCENTS = {
    ...
    "/dashboard/math": "from-emerald-300/26 via-[#DFB15B]/10 to-transparent",
    "/dashboard/math/classes": "from-emerald-300/24 via-cyan-300/8 to-transparent",
    "/dashboard/math/archived-classes": "from-teal-300/22 via-[#DFB15B]/8 to-transparent",
    "/dashboard/math/live-exams": "from-emerald-300/24 via-red-400/8 to-transparent",
    "/dashboard/math/leaderboard": "from-emerald-300/24 via-[#DFB15B]/12 to-transparent",
                ...
                {/* <div className="relative z-10 mb-5 overflow-hidden rounded-3xl border border-[#DFB15B]/16 bg-white/5 p-3 shadow-[0_18px_50px_rgba(0,0,0,0.25)] backdrop-blur">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex flex-col">
                            <span className="font-sans text-base font-bold tracking-wide text-white">Magician&apos;s School</span>
