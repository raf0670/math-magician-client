...
export default function DashboardSidebar() {
    ...
    // 🗺️ Unified navigation links shared between desktop and mobile bars
    const navItems = [
    ...
    return (
        <>
            ...
            <aside className="hidden md:flex flex-col fixed inset-y-0 left-0 w-64 bg-[#0D0B14] border-r border-white/5 z-30 px-5 py-8 select-none">
                ...
                {/* Brand Identity / Platform Header Logo */}
                ...
                <nav className="flex-1 flex flex-col gap-1.5">
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                {/* Active Link Animated Highlight Background Layer */}
                                {isActive && (
                                    <motion.div
                ...
                {/* Baseline Navigation Action Footprint Footer */}
                <div className="border-t border-white/3 pt-4">
                    <button className="w-full flex items-center gap-3.5 px-4 py-3 rounded-xl text-xs font-semibold text-[#6B667B] hover:text-red-400 transition-colors duration-200 group">
            ...
            {/* =========================================================================
                                   MOBILE BOTTOM-DOCKED APP BAR VIEWPORT
               ========================================================================= */}
