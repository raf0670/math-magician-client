...
export default function Hero() {
    ...
    const [hasMounted, setHasMounted] = useState(false); // Safeguard against SSR differences

    // Handle mounting and session fetch safely on client side
    useEffect(() => {
    ...
    // Generate Floating Arcane Mathematical and Alphabetical Symbols
    ...
    return (
        <AnimatePresence>
            <motion.div
                className="w-full bg-[#0D0B14] min-h-[92vh] flex flex-col items-center justify-center pt-20 pb-12 px-6 relative overflow-hidden"
                initial="hidden"
                animate="visible"
                exit="hidden"
                variants={containerVariants}
                key={typeof window !== "undefined" ? window.location.pathname : "hero-void"}
            >
                ...
                <div className="container mx-auto max-w-5xl text-center z-10 flex flex-col items-center justify-center">
