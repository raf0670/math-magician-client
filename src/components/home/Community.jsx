                ...
                >
                    ...
                    >
                        ...
                        <div className="mt-8 pt-5 border-t border-white/3 flex items-center justify-between gap-4">
                            <a href={socialLinks[0].href} target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-xl text-[11px] font-bold tracking-wide transition-all duration-200 active:scale-95 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 border border-blue-500/20">
                                Join Free
                            </a>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="mt-8 pt-5 border-t border-white/3 flex items-center justify-between gap-4">
                            <a href={socialLinks[1].href} target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-xl text-[11px] font-bold tracking-wide transition-all duration-200 active:scale-95 bg-[#DFB15B]/10 hover:bg-[#DFB15B]/20 text-[#DFB15B] border border-[#DFB15B]/20">
                                Join Free
                            </a>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="mt-8 pt-5 border-t border-white/3 flex items-center justify-between gap-4">
                            <a href={socialLinks[2].href} target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-xl text-[11px] font-bold tracking-wide transition-all duration-200 active:scale-95 bg-indigo-600/10 hover:bg-indigo-600/20 text-indigo-400 border border-indigo-500/20">
                                Join Free
                            </a>
                        </div>
                    </motion.div>
