...
export default function Community() {
    ...
    return (
        <section className="w-full bg-[#0D0B14] py-24 px-6 md:px-12 lg:px-24 relative overflow-hidden select-none">
            ...
            {/* 🌌 DEEP AMBIENT RADIAL FIELD MATRICES */}
            <div className="absolute top-[40%] left-[50%] -translate-x-1/2 w-[60vw] h-[60vw] bg-[#7C3AED]/5 rounded-full blur-[140px] pointer-events-none" />
            <div className="absolute bottom-[10%] right-[-5%] w-[40vw] h-[40vw] bg-indigo-950/20 rounded-full blur-[120px] pointer-events-none" />

            <div className="container mx-auto max-w-6xl relative z-10">

                {/* 🏷️ BADGE & TITLE STRUCTURE HEADER */}
                ...
                {/* 🗃️ HARDCODED SOCIAL PORTAL CARDS GRID */}
                <motion.div
                ...
                >
                    ...
                    >
                        <div>
                            <div className="w-11 h-11 rounded-xl flex items-center justify-center border mb-6 bg-blue-500/10 text-blue-400 border-blue-500/20">
                        ...
                        <div className="mt-8 pt-5 border-t border-white/3 flex items-center justify-between gap-4">
                            ...
                            <a href="#" className="px-4 py-2 rounded-xl text-[11px] font-bold tracking-wide transition-all duration-200 active:scale-95 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 border border-blue-500/20A">
                                Join Free
                            </a>
                        </div>
                    </motion.div>

                    {/* CARD 2: FB Group Chat (Highlighted) */}
                    <motion.div
                        variants={cardVariants}
                        whileHover={{ y: -6 }}
                    ...
                    >
                        <div>
                            <div className="w-11 h-11 rounded-xl flex items-center justify-center border mb-6 bg-[#DFB15B]/10 text-[#DFB15B] border-[#DFB15B]/20">
                    ...
                    >
                        <div>
                            <div className="w-11 h-11 rounded-xl flex items-center justify-center border mb-6 bg-indigo-500/10 text-indigo-400 border-indigo-500/20">
                ...
                {/* 🔗 HARDCODED BASELINE FOOTER PILL LINKS BAR */}
                <motion.div
